  ...
  const [testimonials, setTestimonials] = useState([
    {
      ...
      feedback:
        "Blockchain teknolojisi özetle, ağa dahil olan tüm üreticiler tarafından ağda bulunan kayıtların şifreli olarak tutulduğu bir dağıtık defter teknolojisi olarak açıklanabilir. Web 3.0’ın sunduğu aracısız işlem yapabilme durumu blockchain teknolojisiyle mümkün olmaktadır. Blockchain kişi ya da kurumlar arasında aracı bulunmadan eşten eşe ‘‘değer’’ transferinin, aracısız olarak yapılabilmesini sağlayan teknolojidir.",
    },
    {
      name: "NFT",
      company: "",
